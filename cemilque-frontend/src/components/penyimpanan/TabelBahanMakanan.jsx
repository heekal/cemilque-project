...
export default function TabelBahanMakanan() {
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-gray-100 text-gray-900">
                  {["No", "Nama", "Jumlah", "Harga", "Tanggal", "Aksi"].map((head) => (
                    <th 
                      key={head} 
              ...
              <tbody>
                {paginatedData.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={6} className="text-center py-6 text-gray-500 border-b border-gray-200">
      ...
      >
        ...
        <DialogBody className="py-5">
          <Typography className="text-sm text-gray-700">
            Apakah Anda yakin ingin menghapus bahan makanan:
          </Typography>
